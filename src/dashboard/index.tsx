  ...
  async function execute(line: string) {
    ...
    try {
      switch (head) {
        ...
        case "help": append(":status :why :amnesia <мин> [chatId] :reset :stage <id> :wake [chatId] :debug [chatId] :pause :resume :cringe :relationship :persona :log [YYYY-MM-DD] [chars] :appearance [show|preview] :privacy [open|owner-only] :cal [list] | :cal add YYYY-MM-DD [HH:MM] название | :cal del <id> :block [chatId] :unblock [chatId] :read [chatId] :clear-chat [chatId] [--revoke] :report-spam [chatId] :delete-last [chatId] [--local] :edit-last <text> :sticker [chatId] :quit"); break;
